...
import { TodoItemsClient, CreateTodoItemCommand, TodoItemDto, UpdateTodoItemCommand,
         ...
         UpdateTodoItemDetailCommand } from '../casln-api';
...
export class SignalrComponent implements OnInit {
  ...
  constructor(private listsClient: TodoListsClient,
    ...
    private signalrService: SignalrService
      ...
      this.signalrService.itemChanged$.subscribe(updateItem => {
        console.log('UpdateItem', updateItem);
        console.log('current data', this.vm);
        console.log('selectedList', this.selectedList);
        if (this.selectedList && this.selectedList.items) {
          this.updateChangedItem(updateItem);
        }
      });
  }


  updateChangedItem(updateItem: UpdateTodoItemCommand) {
    for (let i of this.selectedList.items) {
      if (i.id == updateItem.id) {
        console.log('updating item ', i);
        i.done = updateItem.done;
